...
@implementation ConferencePhoneReachability
...
#pragma unused (target, flags)
	...
	if ( [(NSObject *)info isKindOfClass: [ConferencePhoneReachability class]] )
	{
		// We're on the main RunLoop, so an NSAutoreleasePool is not necessary, but is added defensively
		// in case someone uses the Reachablity object in a different thread.
		@autoreleasepool {
            ConferencePhoneReachability *noteObject = (ConferencePhoneReachability *)info;
...
{
	ConferencePhoneReachability *retVal = NULL;
...
+(ConferencePhoneReachability*)reachabilityForLocalWiFi;
{
	...
	ConferencePhoneReachability* retVal = [self reachabilityWithAddress: &localWifiAddress];
	if(retVal != NULL)
	{
